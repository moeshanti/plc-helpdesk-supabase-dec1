            ...
            <div className="p-4 border-b border-gray-100 dark:border-slate-700 flex flex-wrap gap-3 items-center bg-gray-50/50 dark:bg-slate-800/50">
                <div className="relative flex-1 min-w-[200px]">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-sm focus:ring-2 focus:ring-brand-500 outline-none transition-all"
                    />
                </div>
